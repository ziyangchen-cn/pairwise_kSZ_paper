...
def pairwise_calculate(dec_rad, ra_rad, redshift, T_ap, lgM, alpha, dd):
    ...
    Equation_M = np.zeros((4,4))
    Equation_A = np.zeros(4)
    Equation_M[ 0, ] = Cij2/N_pair
    Equation_M[ 0, ] = CijZij2/N_pair
    Equation_M[ 0, ] = CijZij/N_pair
    Equation_M[ 0, ] = Cij/N_pair

    Equation_M[ 1, ] = Zij4/N_pair
    Equation_M[ 1, ] = Zij3/N_pair
    Equation_M[ 1, ] = Zij2/N_pair
   

    Equation_M[ 2, ] = Zij2/N_pair
    Equation_M[ 2, ] = Zij/N_pair
